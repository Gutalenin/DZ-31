...
class TestValidRegistrationRT:
    '''Тесты авторизации на РосТелеком'''
...
# 11 Проверка кликабельности бара выбора типа авторизации
...
# 12 Авторизация с не корректным Email
...
# 13 Авторизация с не корректным номером телефона
...
# 14 Авторизация с некорректным паролем
...
# 15 Авторизация с XSS инъекцией

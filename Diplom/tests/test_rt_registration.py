...
class TestValidRegistrationRT:
    '''Тесты Регистрации на РосТелеком'''
    def setup(self):
        self.open()
...
# 1 Регистрация с паролем из 21 символа
...
# 2 Регистрация с Email без домена
...
# 3 Регистрация с именем из 31 символа
...
# 4 Регистрация с именем из 1 символа
...
# 5 Регистрация с незаполненным обязательным полем Email или Телефон
...
# 6 Регистрация с незаполненным обязательным полем Фамилия
...
# 7 Регистрация с незаполненным обязательным полем Имя
...
# 8 Регистрация с несовпадающими паролями
...
# 9 Регистрация с паролем не содержащем цифру
...
# 10 Регистрация с фамилией из 31 символа
